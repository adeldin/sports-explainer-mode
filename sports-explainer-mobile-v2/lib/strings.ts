...
export interface UIStrings {
  // explanation card
  thePlay: string; whyItMatters: string; worthNoting: string; theRule: string; complexPlay: string; updated: string; latestPlay: string; playHeadlineFallback: string; gameNotStarted: string; watchNextLabel: string; liveNowLabel: string; watchNextStartingSoon: string; feedbackPrompt: string; feedbackThanks: string;
  // Free-tier caps — indicators ({n} = remaining), graceful "keep going" blocked states, shared CTA.
  capLeftToday: string; capQaLeft: string; capExplainTitle: string; capExplainBody: string; capQaTitle: string; capQaBody: string; capCta: string; capAcademyCta: string; capCoachCta: string;
  ...
  spBaseball: string; spFootball: string; spBasketball: string; spHockey: string; spSoccer: string; spWorldCup: string; spRugby: string; spWnba: string; spPremierLeague: string; spLaLiga: string; spMlr: string; spTennis: string; spGolf: string; spCricket: string; tennisServing: string; tennisBreakPoint: string; tennisGamePoint: string; tennisFilterAll: string; tennisFilterMens: string; tennisFilterWomens: string;
...
export const UI_STRINGS: Record<Language, UIStrings> = {
  en: {
    ...
    capLeftToday: `{n} left today`, capQaLeft: `{n} questions left`, capExplainTitle: `{n} plays explored today 🎉`, capExplainBody: `Your free plays refresh tomorrow — but the learning doesn't stop.`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `{n} questions this game 🙌`, capQaBody: `Go Pro to keep asking — unlimited questions on every play. A new game gives you more.`, capCta: `Keep going with Pro →`,
  ...
  es: {
    ...
    capLeftToday: `{n} restantes hoy`, capQaLeft: `{n} preguntas restantes`, capExplainTitle: `{n} jugadas exploradas hoy 🎉`, capExplainBody: `Tus jugadas gratis se renuevan mañana, pero el aprendizaje no se detiene.`, capAcademyCta: `Pon a prueba tus conocimientos en la Academia 🎓 →`, capCoachCta: `Aprende estrategia en el Coach's Corner 📋 →`, capQaTitle: `{n} preguntas en este partido 🙌`, capQaBody: `Hazte Pro para seguir preguntando: preguntas ilimitadas en cada jugada. Un nuevo partido te da más.`, capCta: `Continúa con Pro →`,
    ...
    spTennis: `Tennis`, spGolf: `Golf`, spCricket: `Cricket`, worthNoting: `Worth Noting`, watchNextStartingSoon: `Comienza pronto`, tennisFilterAll: `Todos`, tennisFilterMens: `Hombres`, tennisFilterWomens: `Mujeres`, tennisServing: `Al saque`, tennisBreakPoint: `Punto de quiebre`, tennisGamePoint: `Punto de juego`, noTournaments: `No hay torneos esta semana.`, noTournamentsSub: `Vuelve pronto.`, noCricketData: `No hay críquet en vivo ahora mismo.`, noCricketDataSub: `Pregunta lo que quieras sobre el deporte abajo.`, learnModeExplainer: `No hay partidos en vivo ahora mismo: explora el deporte y pregunta lo que quieras abajo.`, learnModeFollowAlong: `Sigue el torneo y pregunta lo que quieras abajo.`, seasonJustEnded: `No hay partidos de {sport} ahora mismo: vuelve la próxima temporada.`,
  },
  ...
  pt: {
    ...
    capLeftToday: `{n} restantes hoje`, capQaLeft: `{n} perguntas restantes`, capExplainTitle: `{n} jogadas exploradas hoje 🎉`, capExplainBody: `Seja Pro para jogadas e perguntas ilimitadas. Suas jogadas grátis renovam amanhã.`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `{n} perguntas neste jogo 🙌`, capQaBody: `Seja Pro para continuar perguntando — perguntas ilimitadas em cada jogada. Um novo jogo dá mais.`, capCta: `Continue com o Pro →`,
  ...
  de: {
    ...
    capLeftToday: `Noch {n} heute`, capQaLeft: `{n} Fragen übrig`, capExplainTitle: `{n} Spielzüge heute erkundet 🎉`, capExplainBody: `Hol dir Pro für unbegrenzte Spielzüge und Fragen. Deine Gratis-Spielzüge gibt es morgen wieder.`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `{n} Fragen in diesem Spiel 🙌`, capQaBody: `Hol dir Pro, um weiter zu fragen — unbegrenzte Fragen zu jedem Spielzug. Ein neues Spiel gibt dir mehr.`, capCta: `Mit Pro weitermachen →`,
  ...
  it: {
    ...
    capLeftToday: `{n} rimaste oggi`, capQaLeft: `{n} domande rimaste`, capExplainTitle: `{n} azioni esplorate oggi 🎉`, capExplainBody: `Passa a Pro per azioni e domande illimitate. Le tue azioni gratis si rinnovano domani.`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `{n} domande in questa partita 🙌`, capQaBody: `Passa a Pro per continuare a chiedere — domande illimitate su ogni azione. Una nuova partita te ne dà altre.`, capCta: `Continua con Pro →`,
  ...
  ja: {
    ...
    capLeftToday: `本日残り{n}回`, capQaLeft: `残り{n}問`, capExplainTitle: `今日は{n}プレーを確認 🎉`, capExplainBody: `Proなら無制限のプレーと質問。無料プレーは明日また使えます。`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `この試合で{n}問 🙌`, capQaBody: `Proで質問を続けよう — どのプレーも質問し放題。新しい試合でさらに。`, capCta: `Proで続ける →`,
  ...
  zh: {
    ...
    capLeftToday: `今日还剩 {n} 次`, capQaLeft: `还剩 {n} 个问题`, capExplainTitle: `今天已了解 {n} 个回合 🎉`, capExplainBody: `升级 Pro 畅享无限回合和提问。免费次数明天刷新。`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `本场比赛 {n} 个问题 🙌`, capQaBody: `升级 Pro 继续提问 — 每个回合都能无限提问。新比赛还有更多。`, capCta: `升级 Pro 继续 →`,
    ...
    spTennis: `Tennis`, spGolf: `Golf`, spCricket: `Cricket`, worthNoting: `Worth Noting`, watchNextStartingSoon: `Starting soon`, tennisFilterAll: `All`, tennisFilterMens: `Men's`, tennisFilterWomens: `Women's`, tennisServing: `Serving`, tennisBreakPoint: `Break point`, tennisGamePoint: `Game point`, noTournaments: `本周没有赛事。`, noTournamentsSub: `请稍后再来。`, noCricketData: `暂时没有板球比赛。`, noCricketDataSub: `在下方随便问关于这项运动的问题吧。`, learnModeExplainer: `目前没有实时比赛——在下方了解这项运动并随便提问。`, learnModeFollowAlong: `一边观看，一边在下方随便提问。`, seasonJustEnded: `目前没有{sport}比赛——下个赛季再来看看。`,
  },
  ...
  ko: {
    ...
    capLeftToday: `오늘 {n}회 남음`, capQaLeft: `질문 {n}개 남음`, capExplainTitle: `오늘 {n}개 플레이 살펴봄 🎉`, capExplainBody: `Pro로 무제한 플레이와 질문을 즐기세요. 무료 플레이는 내일 다시 채워집니다.`, capAcademyCta: `Test your knowledge in the Academy 🎓 →`, capCoachCta: `Learn strategy in the Coach's Corner 📋 →`, capQaTitle: `이 경기에서 질문 {n}개 🙌`, capQaBody: `Pro로 계속 질문하세요 — 모든 플레이에 무제한 질문. 새 경기엔 더 많이.`, capCta: `Pro로 계속하기 →`,
