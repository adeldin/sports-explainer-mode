...
export interface UIStrings {
  ...
  recapEyebrow: string; recapStoryTitle: string; recapTurningPoint: string; recapKeyPerformance: string; recapWhyMattered: string; recapUnlock: string; recapNoData: string;
...
export const UI_STRINGS: Record<Language, UIStrings> = {
  en: {
    ...
    recapEyebrow: `POST-GAME RECAP`, recapStoryTitle: `THE STORY`, recapTurningPoint: `TURNING POINT`, recapKeyPerformance: `KEY PERFORMANCE`, recapWhyMattered: `WHY IT MATTERED`, recapUnlock: `🔓 Unlock the full recap with Pro`, recapNoData: `No recap available for this game yet.`,
  ...
  es: {
    ...
    recapEyebrow: `RESUMEN DEL PARTIDO`, recapStoryTitle: `LA HISTORIA`, recapTurningPoint: `MOMENTO CLAVE`, recapKeyPerformance: `ACTUACIÓN DESTACADA`, recapWhyMattered: `POR QUÉ IMPORTÓ`, recapUnlock: `🔓 Desbloquea el resumen completo con Pro`, recapNoData: `Aún no hay resumen para este partido.`,
  ...
  fr: {
    ...
    recapEyebrow: `APRÈS-MATCH`, recapStoryTitle: `L'HISTOIRE`, recapTurningPoint: `LE TOURNANT`, recapKeyPerformance: `PERFORMANCE CLÉ`, recapWhyMattered: `POURQUOI C'ÉTAIT IMPORTANT`, recapUnlock: `🔓 Débloque le résumé complet avec Pro`, recapNoData: `Pas encore de résumé pour ce match.`,
  ...
  pt: {
    ...
    recapEyebrow: `PÓS-JOGO`, recapStoryTitle: `A HISTÓRIA`, recapTurningPoint: `A VIRADA`, recapKeyPerformance: `DESTAQUE`, recapWhyMattered: `POR QUE IMPORTOU`, recapUnlock: `🔓 Desbloqueie o resumo completo com o Pro`, recapNoData: `Ainda não há resumo para este jogo.`,
  ...
  de: {
    ...
    recapEyebrow: `SPIELBERICHT`, recapStoryTitle: `DIE GESCHICHTE`, recapTurningPoint: `WENDEPUNKT`, recapKeyPerformance: `TOP-LEISTUNG`, recapWhyMattered: `WARUM ES WICHTIG WAR`, recapUnlock: `🔓 Vollen Bericht mit Pro freischalten`, recapNoData: `Noch kein Bericht für dieses Spiel.`,
  ...
  it: {
    ...
    recapEyebrow: `DOPO-PARTITA`, recapStoryTitle: `LA STORIA`, recapTurningPoint: `LA SVOLTA`, recapKeyPerformance: `PRESTAZIONE CHIAVE`, recapWhyMattered: `PERCHÉ HA CONTATO`, recapUnlock: `🔓 Sblocca il resoconto completo con Pro`, recapNoData: `Ancora nessun resoconto per questa partita.`,
  ...
  ja: {
    ...
    recapEyebrow: `試合レビュー`, recapStoryTitle: `試合の流れ`, recapTurningPoint: `ターニングポイント`, recapKeyPerformance: `注目の活躍`, recapWhyMattered: `なぜ重要だったか`, recapUnlock: `🔓 Proで完全なレビューを解除`, recapNoData: `この試合のレビューはまだありません。`,
  ...
  zh: {
    ...
    recapEyebrow: `赛后回顾`, recapStoryTitle: `比赛经过`, recapTurningPoint: `转折点`, recapKeyPerformance: `关键表现`, recapWhyMattered: `为何重要`, recapUnlock: `🔓 升级 Pro 解锁完整回顾`, recapNoData: `暂无本场比赛的回顾。`,
  ...
  ko: {
    ...
    recapEyebrow: `경기 리뷰`, recapStoryTitle: `경기 흐름`, recapTurningPoint: `분수령`, recapKeyPerformance: `주목할 활약`, recapWhyMattered: `왜 중요했나`, recapUnlock: `🔓 Pro로 전체 리뷰 잠금 해제`, recapNoData: `아직 이 경기의 리뷰가 없습니다.`,
  ...
  ar: {
    ...
    recapEyebrow: `ملخص المباراة`, recapStoryTitle: `القصة`, recapTurningPoint: `نقطة التحول`, recapKeyPerformance: `الأداء البارز`, recapWhyMattered: `لماذا كانت مهمة`, recapUnlock: `🔓 افتح الملخص الكامل مع Pro`, recapNoData: `لا يوجد ملخص لهذه المباراة بعد.`,
