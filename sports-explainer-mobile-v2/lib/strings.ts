...
export interface UIStrings {
  // explanation card
  thePlay: string; whyItMatters: string; theRule: string; complexPlay: string; updated: string; latestPlay: string; playHeadlineFallback: string; gameNotStarted: string; watchNextLabel: string; liveNowLabel: string; watchNextStartingSoon: string; feedbackPrompt: string; feedbackThanks: string;
...
export const UI_STRINGS: Record<Language, UIStrings> = {
  ...
  es: {
    ...
    spTennis: `Tennis`, spGolf: `Golf`, spCricket: `Cricket`, watchNextStartingSoon: `Comienza pronto`, tennisFilterAll: `Todos`, tennisFilterMens: `Hombres`, tennisFilterWomens: `Mujeres`, tennisServing: `Al saque`, tennisBreakPoint: `Punto de quiebre`, tennisGamePoint: `Punto de juego`, noTournaments: `No hay torneos esta semana.`, noTournamentsSub: `Vuelve pronto.`, noCricketData: `No hay críquet en vivo ahora mismo.`, noCricketDataSub: `Pregunta lo que quieras sobre el deporte abajo.`, learnModeExplainer: `No hay partidos en vivo ahora mismo: explora el deporte y pregunta lo que quieras abajo.`, learnModeFollowAlong: `Sigue el torneo y pregunta lo que quieras abajo.`, seasonJustEnded: `No hay partidos de {sport} ahora mismo: vuelve la próxima temporada.`,
  },
