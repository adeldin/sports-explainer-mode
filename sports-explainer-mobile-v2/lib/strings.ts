...
export interface UIStrings {
  ...
  spBaseball: string; spFootball: string; spBasketball: string; spHockey: string; spSoccer: string; spWorldCup: string; spRugby: string; spWnba: string; spPremierLeague: string; spLaLiga: string; spMlr: string; spTennis: string; spGolf: string; spCricket: string; tennisServing: string; tennisBreakPoint: string; tennisGamePoint: string;
...
export const UI_STRINGS: Record<Language, UIStrings> = {
  ...
  es: {
    ...
    spTennis: `Tennis`, spGolf: `Golf`, spCricket: `Cricket`, tennisServing: `Al saque`, tennisBreakPoint: `Punto de quiebre`, tennisGamePoint: `Punto de juego`, noTournaments: `No hay torneos esta semana.`, noTournamentsSub: `Vuelve pronto.`, noCricketData: `No hay críquet en vivo ahora mismo.`, noCricketDataSub: `Pregunta lo que quieras sobre el deporte abajo.`, learnModeExplainer: `No hay partidos en vivo ahora mismo: explora el deporte y pregunta lo que quieras abajo.`, learnModeFollowAlong: `Sigue el torneo y pregunta lo que quieras abajo.`, seasonJustEnded: `No hay partidos de {sport} ahora mismo: vuelve la próxima temporada.`,
  },
