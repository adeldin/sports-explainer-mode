...
export const BASEBALL_GLOSSARY: GlossaryEntry[] = [
  ...
  {
    term: 'strike',
    match: 'swing-and-miss or zone pitch',
  ...
  {
    term: 'foul ball',
    match: 'hit out of fair territory',
  ...
  },
  {
    ...
    match: 'caught watching strike three',
  ...
  {
    term: 'hit by pitch',
    match: 'batter plunked, takes base',
  ...
  {
    term: "hitter's count",
    match: 'count favoring the batter',
  ...
  },
  {
    ...
    match: 'count favoring the pitcher',
  ...
  {
    term: 'splitter',
    match: 'drops late, fools hitters',
  ...
  {
    term: 'changeup',
    match: 'slow pitch disguised as fast',
  ...
  {
    term: 'wild pitch',
    match: 'uncatchable errant throw',
  ...
  {
    term: 'sacrifice fly',
    match: 'fly ball scores a runner',
  ...
  {
    term: 'stolen base',
    match: 'runner takes the next base',
  ...
  },
  {
    ...
    match: 'runner thrown out stealing',
  ...
  {
    term: 'tag up',
    match: 'retouch base before running',
  ...
  {
    term: 'RISP',
    match: 'runner in scoring position',
  ...
  {
    term: 'force out',
    match: 'runner forced to the base',
  ...
  },
  {
    ...
    match: 'defense plays a different runner',
  ...
  {
    term: 'closer',
    match: 'the ninth-inning specialist',
  ...
  {
    term: 'no-hitter',
    match: 'a game with no hits allowed',
