...
export type Sport = 'nfl' | 'nba' | 'mlb' | 'nhl' | 'soccer' | 'worldcup' | 'rugby' | 'wnba' | 'epl' | 'laliga' | 'seriea' | 'bundesliga' | 'mlr' | 'tennis' | 'golf' | 'cricket' | 'nationscup' | 'sixnations' | 'nationschamp' | 'superrugby' | 'championscup' | 'challengecup' | 'cfb' | 'cbb';
