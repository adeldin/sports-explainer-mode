...
export default function GoOrLayGame(_props: AcademyGameProps) {
  ...
  const legend = (
    <View style={styles.legend}>
      ...
      <Text style={styles.legendTxt}><Text style={styles.legendBold}>E 2.92</Text> = expected strokes to hole out from that spot</Text>
      <Text style={styles.legendMuted}>assumes flat lie · calm air</Text>
      <View style={styles.legendItem}><View style={[styles.legendSq, styles.legendDashed, { borderColor: '#F4F4EE' }]} /><Text style={styles.legendTxt}>Dispersion oval — where your misses land</Text></View>
      <View style={styles.legendItem}><View style={[styles.legendSq, styles.legendDashed, { borderColor: TEAL }]} /><Text style={styles.legendTxt}>Ghost = the better zone</Text></View>
    </View>
  );
