...
export default function PickYourPoisonGame(_props: AcademyGameProps) {
  ...
  const legend = (
    <View style={[styles.legend, landscape && styles.legendLs]}>
      ...
      <View style={styles.legendItem}><View style={[styles.legendSwatch, { backgroundColor: 'rgba(20,184,166,.35)' }]} /><Text style={[styles.legendTxt, landscape && styles.legendTxtLs]}>open shot window</Text></View>
      <View style={styles.legendItem}><View style={[styles.legendSwatch, { backgroundColor: 'rgba(244,244,238,.5)' }]} /><Text style={[styles.legendTxt, landscape && styles.legendTxtLs]}>dashed lanes = the 4-on-3 the pass opens</Text></View>
      <View style={styles.legendItem}><View style={styles.legendGhost} /><Text style={[styles.legendTxt, landscape && styles.legendTxtLs]}>where the right coverage was</Text></View>
    </View>
  );
