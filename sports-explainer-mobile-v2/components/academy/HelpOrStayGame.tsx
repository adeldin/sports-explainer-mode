...
export default function HelpOrStayGame(_props: AcademyGameProps) {
  ...
  const legend = (
    <View style={[styles.legend, landscape && styles.legendLs]}>
      ...
      <View style={styles.legendItem}><View style={[styles.legendSwatch, { backgroundColor: 'rgba(226,75,74,.4)' }]} /><Text style={[styles.legendTxt, landscape && styles.legendTxtLs]}>open runway</Text></View>
      <View style={styles.legendItem}><View style={styles.legendGhost} /><Text style={[styles.legendTxt, landscape && styles.legendTxtLs]}>where the right call was</Text></View>
    </View>
  );
