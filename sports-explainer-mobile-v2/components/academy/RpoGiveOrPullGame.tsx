...
export default function RpoGiveOrPullGame(_props: AcademyGameProps) {
  ...
  const legend = (
    <View style={styles.legend}>
      ...
      <View style={styles.legendItem}><View style={styles.legendRing} /><Text style={styles.legendTxt}>the read defender</Text></View>
    </View>
  );
  ...
  const lsFooter = (
    <View style={styles.lsPostRow}>
      ...
      {answered
        ...
        : <Text style={styles.hintTxt} numberOfLines={2}>Same play, three answers.</Text>}
    </View>
  );
...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  replay: { position: 'absolute', top: 10, left: 10, borderWidth: 1.5, borderStyle: 'dashed', borderColor: 'rgba(244,244,238,.75)', backgroundColor: 'rgba(13,27,62,.6)', paddingHorizontal: 11, paddingVertical: 8, borderRadius: 9 },
